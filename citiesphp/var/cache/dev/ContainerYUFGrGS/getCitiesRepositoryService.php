...
// Returns the private 'App\Repository\CitiesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CitiesRepository.php';

return $this->privates['App\\Repository\\CitiesRepository'] = new \App\Repository\CitiesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
