...
return $this->services['services_resetter'] = new \Symfony\Component\HttpKernel\DependencyInjection\ServicesResetter(new RewindableGenerator(function () {
    ...
    return 0 + (int) (isset($this->privates['http_exception_listener'])) + (int) (isset($this->services['session'])) + (int) (isset($this->privates['form.choice_list_factory.cached'])) + (int) (isset($this->privates['debug.stopwatch'])) + (int) (isset($this->privates['form.type.entity'])) + (int) (isset($this->services['fos_rest.view_handler']));
}), ['http_exception_listener' => 'reset', 'session' => 'save', 'form.choice_list_factory.cached' => 'reset', 'debug.stopwatch' => 'reset', 'form.type.entity' => 'reset', 'fos_rest.view_handler.default' => 'reset']);
