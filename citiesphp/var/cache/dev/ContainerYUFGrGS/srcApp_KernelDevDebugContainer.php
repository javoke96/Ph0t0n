...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\CitiesController' => 'getCitiesControllerService.php',
    ...
    protected function getFosRest_FormatListenerService()
    {
        ...
        $a->add(new \Symfony\Component\HttpFoundation\RequestMatcher('api2/', NULL, NULL, NULL, []), ['priorities' => [0 => 'text/html', 1 => '*/*'], 'fallback_format' => 'html', 'prefer_extension' => '2.0', 'methods' => NULL, 'attributes' => [], 'stop' => false]);
